...
////   free to use your own! The weighted cost over all cost functions is
///computed /   in calculate_cost. The data from get_helper_data will be very
///useful in /   your implementation of the cost functions below. Please see
///get_helper_data /   for details on how the helper data is computed.
//
